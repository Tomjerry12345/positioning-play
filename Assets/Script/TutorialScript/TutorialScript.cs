...
//    //[TextArea(3, 5)] public string[] listText1;
...
//    //[Header("Content 3")]
//    //public TMP_Text textZonaIdeal;
//    //public TMP_Text textZonaNetral;
//    //public TMP_Text textZonaRawan;

//    //[TextArea(3, 5)] public string[] listZonaIdeal;
//    //[TextArea(3, 5)] public string[] listZonaNetral;
//    //[TextArea(3, 5)] public string[] listZonaRawan;

//    [Header("Slides")]
//    public GameObject[] listObjectContent;
...
//    private String[] listRole = { "DM", "AM", "CM" };
//    private int indexRole = 0;
...
//        if (position.Equals("Gelandang Bertahan", System.StringComparison.OrdinalIgnoreCase))
//        {
//            indexRole = 0;
...
//            //};
//        }
//        else if (position.Equals("Gelandang Serang", System.StringComparison.OrdinalIgnoreCase))
//        {
//            indexRole = 1;
...
//        role = listRole[indexRole];
//        SetupImage(indexRole);
...
//        if (image != null)
//        {
//            image.sprite = listImage[index];
//        }
//        else
//        {
//            Debug.LogWarning("Image atau Sprite tidak ditemukan!");
//        }
//    }
...
//    {
//        //if (newIndex == currentIndex || newIndex < 0 || newIndex >= listText1.Length)
...
public class TutorialScript : MonoBehaviour
{
    ...
    [Header("Slides - Content Objects")]
    public GameObject[] listObjectContent; // Content 1, Content 2, Content 3
    ...
    void SetupImage(int index)
    {
        if (image != null && listImage != null && index < listImage.Length)
        {
            image.sprite = listImage[index];
        }
        else
    ...
    {
        // Validasi index
        if (newIndex == currentIndex || newIndex < 0 || newIndex >= listObjectContent.Length)
            return;
    ...
    void UpdateContent(int index)
    {
        ...
        // KUNCI: Aktifkan content yang sesuai, non-aktifkan yang lain
        ShowContentObject(index);

        // Update indicator dots
        UpdateIndicators(index);
    }

    void ShowContentObject(int index)
    {
        // Loop semua content objects
        for (int i = 0; i < listObjectContent.Length; i++)
        {
            if (listObjectContent[i] != null)
            {
                // Aktifkan hanya content yang sesuai index
                listObjectContent[i].SetActive(i == index);
            }
        }
    }
